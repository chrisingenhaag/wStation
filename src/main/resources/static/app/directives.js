var wStationDirectives = angular.module('wStation.directives',
		[ 'wStation.services' ]);

wStationDirectives.directive('barChart', [ 'd3Service', function(d3Service) {
	return {
															...
															renderTimeout = $timeout(
																	function() {
																		var width = d3
																				...
																				* (barHeight + barPadding), color = d3.scale
																				.category20(), xScale = d3.scale
																				.linear()
																				.domain(
																						[
																								0,
